using TradeGenius.WebApi.Application.Catalog.Products;
...
{
    [HttpPost("search")]
    [MustHavePermission(TradeGeniusAction.Search, TradeGeniusResource.Products)]
    ...
    [HttpGet("{id:guid}")]
    [MustHavePermission(TradeGeniusAction.View, TradeGeniusResource.Products)]
    ...
    [HttpPost]
    [MustHavePermission(TradeGeniusAction.Create, TradeGeniusResource.Products)]
    ...
    [HttpPut("{id:guid}")]
    [MustHavePermission(TradeGeniusAction.Update, TradeGeniusResource.Products)]
    ...
    [HttpDelete("{id:guid}")]
    [MustHavePermission(TradeGeniusAction.Delete, TradeGeniusResource.Products)]
    ...
    [HttpPost("export")]
    [MustHavePermission(TradeGeniusAction.Export, TradeGeniusResource.Products)]
