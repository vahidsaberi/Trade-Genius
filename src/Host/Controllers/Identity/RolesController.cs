...
public class RolesController : VersionNeutralApiController
{
    ...
    [HttpGet]
    [MustHavePermission(TradeGeniusAction.View, TradeGeniusResource.Roles)]
    ...
    [MustHavePermission(TradeGeniusAction.View, TradeGeniusResource.RoleClaims)]
    ...
    [MustHavePermission(TradeGeniusAction.Update, TradeGeniusResource.RoleClaims)]
    ...
    [HttpPost]
    [MustHavePermission(TradeGeniusAction.Create, TradeGeniusResource.Roles)]
    ...
    [HttpDelete("{id}")]
    [MustHavePermission(TradeGeniusAction.Delete, TradeGeniusResource.Roles)]
