...
namespace TradeGenius.WebApi.Application.Utils;
public static class TypeProvider
{
    ...
    public static IReadOnlyList<Assembly> GetApplicationPartAssemblies(Assembly rootAssembly)
    {
        ...
        var list = rootAssembly.GetReferencedAssemblies()
            .Where(x => x.Name.StartsWith(rootNamespace, StringComparison.InvariantCulture))
