...
using TradeGenius.WebApi.Domain.Common.Events;
...
using TradeGenius.WebApi.Application.Utils;
...
public class PersistMessageProcessor : IPersistMessageProcessor
{
    ...
    private readonly ApplicationDbContext _persistMessageDbContext;
    ...
    public PersistMessageProcessor(
        ...
        IMediator mediator,
        ApplicationDbContext persistMessageDbContext,
