...
using System.Text;
using TradeGenius.WebApi.Application.Common.Exceptions;
using TradeGenius.WebApi.Application.Identity.Tokens;
using TradeGenius.WebApi.Infrastructure.Auth;
using TradeGenius.WebApi.Infrastructure.Auth.Jwt;
...
namespace TradeGenius.WebApi.Infrastructure.Identity;
...
internal class TokenService : ITokenService
{
    ...
    private readonly TradeGeniusTenantInfo? _currentTenant;

    public TokenService(
        UserManager<ApplicationUser> userManager,
        IOptions<JwtSettings> jwtSettings,
        IStringLocalizer<TokenService> localizer,
        TradeGeniusTenantInfo? currentTenant,
    ...
    private IEnumerable<Claim> GetClaims(ApplicationUser user, string ipAddress) =>
        new List<Claim>
        {
            ...
            new(TradeGeniusClaims.Fullname, $"{user.FirstName} {user.LastName}"),
            new(ClaimTypes.Name, user.FirstName ?? string.Empty),
            new(ClaimTypes.Surname, user.LastName ?? string.Empty),
            new(TradeGeniusClaims.IpAddress, ipAddress),
            new(TradeGeniusClaims.Tenant, _currentTenant!.Id),
            new(TradeGeniusClaims.ImageUrl, user.ImageUrl ?? string.Empty),
