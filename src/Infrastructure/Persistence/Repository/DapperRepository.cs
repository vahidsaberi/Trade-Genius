...
using TradeGenius.WebApi.Domain.Common.Contracts;
using TradeGenius.WebApi.Infrastructure.Persistence.Context;

namespace TradeGenius.WebApi.Infrastructure.Persistence.Repository;
...
public class DapperRepository : IDapperRepository
{
    ...
    where T : class, IEntity =>
         (await _dbContext.Connection.QueryAsync<T>(sql, param, transaction)).ToList();

    public async Task<IReadOnlyList<T>> QueryWithTenantAsync<T>(string sql, object? param = null, IDbTransaction? transaction = null, CancellationToken cancellationToken = default)
    where T : class, IEntity
    {
