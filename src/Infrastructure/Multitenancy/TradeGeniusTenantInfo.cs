...
public class TradeGeniusTenantInfo : ITenantInfo
{
    public TradeGeniusTenantInfo()
    {
    }

    public TradeGeniusTenantInfo(string id, string name, string? connectionString, string adminEmail, string? issuer = null)
    {
        Id = id;
        Identifier = id;
        Name = name;
